...
log_level = 'INFO'
load_from = './work_dirs/report_rellis/ours_class_att_group_rellis_group4/iter_160000.pth'
resume_from = None
workflow = [('train', 1)]
...
work_dir = './work_dirs/ours_class_att_group_rellis_group4_ws'
gpu_ids = range(0, 1)
