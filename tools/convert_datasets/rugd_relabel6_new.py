...
# 2 Granular: Sand, Dirt, mulch, gravel, water, rockbed
# 3 Poor foothold: rocks
...
Groups = [2, 2, 4, 5, 5, 2, 0, 5, 5, 1, 2, 5, 2, 2, 4, 5, 5, 5, 4, 5, 3, 5, 1, 5]
...
with open(osp.join(rudg_dir, 'train_ours.txt'), 'r') as r:
    ...
    for l in r:
        ...
        out2 = raw_to_seq(out)
        mmcv.imwrite(out2, rudg_dir + annotation_folder + l.strip() + "_group6new.png")
